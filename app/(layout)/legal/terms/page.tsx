    ...
    <div>
      ...
      <Layout>
        <LayoutContent className="prose m-auto mb-8 dark:prose-invert">
          <Typography variant="small">Last updated: July 16, 2024</Typography>
          ...
          <ul>
            ...
            <li>
              <Typography variant="p">
                ...
                in this Agreement) refers to Bonificator.
              </Typography>
            </li>
            <li>
              <Typography variant="p">
            ...
            <li>
              <Typography variant="p">
                <strong>Website</strong> refers to Bonificator, accessible from{" "}
                <a
                  href="https://bonificator.vercel.app/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://bonificator.vercel.app/
                </a>
              </Typography>
            </li>
            <li>
          ...
          <ul>
            <li>
              ...
              <a
                href="https://bonificator.vercel.app/contact/contact-us"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://bonificator.vercel.app/contact/contact-us
              </a>
            </li>
          </ul>
        </LayoutContent>
