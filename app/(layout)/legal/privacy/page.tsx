        ...
        <LayoutContent className="prose mb-8 dark:prose-invert">
          ...
          <ul>
            ...
            <li>
              <Typography variant="p">
                ...
                <a
                  href="http://bonificator.vercel.app/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  http://bonificator.vercel.app/
                </a>
              </Typography>
            </li>
            <li>
          ...
          <ul>
            <li>
              ...
              <a
                href="http://bonificator.vercel.app/contact/contact-us"
                rel="external nofollow noopener"
                target="_blank"
              >
                http://bonificator.vercel.app/contact/contact-us
              </a>
            </li>
          </ul>
        </LayoutContent>
